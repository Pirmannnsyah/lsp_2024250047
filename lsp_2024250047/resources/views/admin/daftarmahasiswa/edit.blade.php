...
<body class="bg-gray-100 flex flex-col min-h-screen">
    ...
    <main class="flex-grow">
        <div class="max-w-3xl mx-auto bg-white shadow-md rounded-lg p-8 mt-6">
            ...
            <form action="/admin/daftarmahasiswa/{{$daftarmahasiswa->id}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <!-- Nama Depan -->
                    <div>
                        <label for="first_name" class="p-2 block text-sm font-medium text-gray-700">Nama Depan</label>
                    ...
                    <!-- Nama Belakang -->
                    <div>
                        <label for="last_name" class="p-2 block text-sm font-medium text-gray-700">Nama Belakang</label>
                ...
                <!-- Tanggal Lahir -->
                <div class="mb-6">
                    <label for="birth_date" class="p-2 block text-sm font-medium text-gray-700">Tanggal Lahir</label>
                ...
                <div class="mb-6">
                    ...
                    <textarea id="address" name="address" rows="4" class="p-2 mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>{{ old('address', $daftarmahasiswa->address) }}</textarea>
                </div>
                ...
                <div class="mb-6">
                    <label for="payment_proof" class="p-2 block text-sm font-medium text-gray-700">Upload Bukti Pembayaran</label>
                    ...
                    @endif
                    <input id="payment_proof" type="file" name="payment_proof" class="p-2 mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                </div>
